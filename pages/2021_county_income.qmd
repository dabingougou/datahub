...
author: [Huibin Chang(mailto: huibin.chang@berkeley.edu)]
format: html
execute:
  echo: false
meta:
  og:title: "Interactive U.S. County Income Map"
  og:description: "Explore the interactive map of U.S. counties showing per-person income data."
  og:image: "https://dabingougou.github.io/datahub/income_thumbnail.png"
  og:url: "https://dabingougou.github.io/datahub/county_income_map.html"
  og:type: "website"
...
What's the income level in your county, according to the 2021 US Census (ACS)? Per person annual income is shown in this interactive map. Note that personal income is generally lower than wage due to a portion of the population not earning wage income. Per person annual income is calculated as (for county $i$):
...
#    title = "2021 US Census Per-person Income (quintiles)",
  ...
  <!-- X (Twitter) -->
  <a href="https://twitter.com/intent/tweet?text=Explore+this+interactive+map:+&url=https://dabingougou.github.io/datahub/county_income_map.html" 
     target="_blank">
  ...
  <!-- LinkedIn -->
  <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://dabingougou.github.io/datahub/county_income_map.html" 
     target="_blank">
  ...
  <!-- Facebook -->
  <a href="https://www.facebook.com/sharer/sharer.php?u=https://dabingougou.github.io/datahub/county_income_map.html" 
     target="_blank">
...
# Save the standalone map to an HTML file
...
The two tables below show the top and bottom 20 counties in the US ranked by personal income.
```{r generate_tables, echo=FALSE, message=FALSE, warning=FALSE}
top_20 <- census_county %>%
...
kable(top_20, caption = "Most affluent counties")

bottom_20 <- census_county %>%
...
kable(bottom_20, caption = "Least affluent counties")
